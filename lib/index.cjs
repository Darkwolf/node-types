const { isArgumentsObject, isProxy, isModuleNamespaceObject } = require('util/types')
const {
  isPrimitive,
  Object,
  ObjectFreeze,
...
const isArguments = isArgumentsObject
const isIterator = value => ObjectPrototypeIsPrototypeOf(IteratorPrototype, value)
const isArrayIterator = value => ObjectPrototypeIsPrototypeOf(ArrayIteratorPrototype, value)
const isStringIterator = value => ObjectPrototypeIsPrototypeOf(StringIteratorPrototype, value)
const isMapIterator = value => ObjectPrototypeIsPrototypeOf(MapIteratorPrototype, value)
const isSetIterator = value => ObjectPrototypeIsPrototypeOf(SetIteratorPrototype, value)
const isRegExpStringIterator = value => ObjectPrototypeIsPrototypeOf(RegExpStringIteratorPrototype, value)
const isGenerator = value => ObjectPrototypeIsPrototypeOf(GeneratorPrototype, value)
const isAsyncGenerator = value => ObjectPrototypeIsPrototypeOf(AsyncGeneratorPrototype, value)
const isAnyGenerator = value => ArrayPrototypeSome([
  GeneratorPrototype,
  AsyncGeneratorPrototype

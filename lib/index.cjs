...
const isIterable = value => isObject(value) && isFunction(value[SymbolIterator])
const isAsyncIterable = value => isObject(value) && isFunction(value[SymbolAsyncIterator])
const isAnyIterable = value => isObject(value) && ArrayPrototypeSome([
  SymbolIterator,
  SymbolAsyncIterator

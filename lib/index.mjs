import { isArgumentsObject, isProxy, isModuleNamespaceObject } from 'util/types'
...
export const isArguments = isArgumentsObject
export const isIterator = value => ObjectPrototypeIsPrototypeOf(IteratorPrototype, value)
export const isArrayIterator = value => ObjectPrototypeIsPrototypeOf(ArrayIteratorPrototype, value)
export const isStringIterator = value => ObjectPrototypeIsPrototypeOf(StringIteratorPrototype, value)
export const isMapIterator = value => ObjectPrototypeIsPrototypeOf(MapIteratorPrototype, value)
export const isSetIterator = value => ObjectPrototypeIsPrototypeOf(SetIteratorPrototype, value)
export const isRegExpStringIterator = value => ObjectPrototypeIsPrototypeOf(RegExpStringIteratorPrototype, value)
export const isGenerator = value => ObjectPrototypeIsPrototypeOf(GeneratorPrototype, value)
export const isAsyncGenerator = value => ObjectPrototypeIsPrototypeOf(AsyncGeneratorPrototype, value)
export const isAnyGenerator = value => ArrayPrototypeSome([
  GeneratorPrototype,
  AsyncGeneratorPrototype
], prototype => ObjectPrototypeIsPrototypeOf(prototype, value))
...
export const isIterable = value => value != null && isFunction(value[SymbolIterator])
export const isAsyncIterable = value => value != null && isFunction(value[SymbolAsyncIterator])
export const isAnyIterable = value => value != null && ArrayPrototypeSome([
  SymbolIterator,
  SymbolAsyncIterator
